...
ROOT_DIR = environ.Path(__file__) - 3  # (chamados/config/settings/base.py - 3 = canto/)
APPS_DIR = ROOT_DIR.path('chamados')
...
ADMINS = [
    ("""Alexandre Odoni""", 'aleodoni@gmail.com'),
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            str(APPS_DIR.path('templates/telefonia')),
        ],
        'OPTIONS': {
...
########## CELERY
#INSTALLED_APPS += ['chamados.taskapp.celery.CeleryConfig']
